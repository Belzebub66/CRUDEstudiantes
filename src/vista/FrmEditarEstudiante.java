...
public class FrmEditarEstudiante extends javax.swing.JFrame {
        ...
        private void buscar() {
                ...
                if (registro != null) {
                        ...
                        this.rdbtnGrupoA.setEnabled(true);
                        this.rdbtnGrupoB.setEnabled(true);
                        this.rdbtnGrupoC.setEnabled(true);
                        this.cboCarrera.setEnabled(true);
        ...
        private void editar() {
                ...
                this.objControladorCRUDEst.modificarRegistro(numControl, nombre, apellidos, semestre, grupo, carrera);
                JOptionPane.showMessageDialog(this.objControladorCRUDEst.objVistaCRUDEst, "Registro Editado");
                this.limpiarCampos();
                this.txtNumControl.requestFocus();
        }
