...
public class ControladorCRUDEstudiantes {
    ...
    public void modificarRegistro(String nc, String nom, String ape, String sem, String gpo, String carrera) {
        this.objArchivo = new ArchivoTexto();
        this.objArchivo.abrirArchivoTexto('r', "estudiantes.txt");
        this.objArchivo.modificarLinea(nc, nom, ape, sem, gpo, carrera);
        this.objArchivo.cerrarArchivo('r');
